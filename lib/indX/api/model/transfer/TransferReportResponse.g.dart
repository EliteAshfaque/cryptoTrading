...
part of 'TransferReportResponse.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TransferReportResponse _$TransferReportResponseFromJson(
        Map<String, dynamic> json) =>
    TransferReportResponse(
      withdrawalWalletReport: (json['withdrawalWalletReport'] as List<dynamic>?)
          ?.map(
              (e) => WithdrawalWalletReport.fromJson(e as Map<String, dynamic>))
          .toList(),
      withdrawalCryptoReport: (json['withdrawalCryptoReport'] as List<dynamic>?)
          ?.map(
              (e) => WithdrawalWalletReport.fromJson(e as Map<String, dynamic>))
          .toList(),
      dmtReport: (json['dmtReport'] as List<dynamic>?)
          ?.map((e) => SendMoneyBankReport.fromJson(e as Map<String, dynamic>))
          .toList(),
    )
...
Map<String, dynamic> _$TransferReportResponseToJson(
        TransferReportResponse instance) =>
    <String, dynamic>{
      ...
      'withdrawalWalletReport': instance.withdrawalWalletReport,
      'withdrawalCryptoReport': instance.withdrawalCryptoReport,
      'dmtReport': instance.dmtReport,
    };
