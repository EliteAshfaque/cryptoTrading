...
part of 'GetTechnologyQrResponse.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GetTechnologyQrResponse _$GetTechnologyQrResponseFromJson(
        Map<String, dynamic> json) =>
    GetTechnologyQrResponse(
      technologyId: (json['technologyId'] as num?)?.toInt(),
      techaddressUrl: json['techaddressUrl'] as String?,
...
Map<String, dynamic> _$GetTechnologyQrResponseToJson(
        GetTechnologyQrResponse instance) =>
    <String, dynamic>{
      ...
      'techaddressUrl': instance.techaddressUrl,
      'technologyName': instance.technologyName,
      'techName': instance.techName,
      'techCode': instance.techCode,
