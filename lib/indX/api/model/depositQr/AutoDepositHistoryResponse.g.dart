...
part of 'AutoDepositHistoryResponse.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AutoDepositHistoryResponse _$AutoDepositHistoryResponseFromJson(
        Map<String, dynamic> json) =>
    AutoDepositHistoryResponse(
      data: (json['data'] as List<dynamic>?)
          ?.map((e) => AutoDepositHistory.fromJson(e as Map<String, dynamic>))
          .toList(),
    )
...
Map<String, dynamic> _$AutoDepositHistoryResponseToJson(
        AutoDepositHistoryResponse instance) =>
    <String, dynamic>{
