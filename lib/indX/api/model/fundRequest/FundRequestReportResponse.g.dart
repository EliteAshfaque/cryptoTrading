...
part of 'FundRequestReportResponse.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

FundRequestReportResponse _$FundRequestReportResponseFromJson(
        Map<String, dynamic> json) =>
    FundRequestReportResponse(
      data: (json['data'] as List<dynamic>?)
          ?.map((e) => FundRequestReport.fromJson(e as Map<String, dynamic>))
          .toList(),
    )
...
Map<String, dynamic> _$FundRequestReportResponseToJson(
        FundRequestReportResponse instance) =>
    <String, dynamic>{
