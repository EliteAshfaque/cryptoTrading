...
part of 'RecentPinActivityResponse.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

RecentPinActivityResponse _$RecentPinActivityResponseFromJson(
        Map<String, dynamic> json) =>
    RecentPinActivityResponse(
      data: (json['data'] as List<dynamic>?)
          ?.map(
              (e) => RecentPinActivityData.fromJson(e as Map<String, dynamic>))
          .toList(),
    )
...
Map<String, dynamic> _$RecentPinActivityResponseToJson(
        RecentPinActivityResponse instance) =>
    <String, dynamic>{
