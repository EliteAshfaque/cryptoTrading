...
part of 'CurrencyBalanceData.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CurrencyBalanceData _$CurrencyBalanceDataFromJson(Map<String, dynamic> json) =>
    CurrencyBalanceData(
      balance: json['balance'] as String?,
      fiatCurrSymbol: json['fiatCurrSymbol'] as String?,
      balanceInUSDT: (json['balanceInUSDT'] as num?)?.toDouble(),
      balanceInFiat: (json['balanceInFiat'] as num?)?.toDouble(),
      fiatCurrID: (json['fiatCurrID'] as num?)?.toInt(),
      fiatTechnologyId: (json['fiatTechnologyId'] as num?)?.toInt(),
      requestedCurrID: (json['requestedCurrID'] as num?)?.toInt(),
    )
...
Map<String, dynamic> _$CurrencyBalanceDataToJson(
        CurrencyBalanceData instance) =>
    <String, dynamic>{
      ...
      'balanceInUSDT': instance.balanceInUSDT,
      'balanceInFiat': instance.balanceInFiat,
      'fiatCurrID': instance.fiatCurrID,
      'fiatTechnologyId': instance.fiatTechnologyId,
      'requestedCurrID': instance.requestedCurrID,
    };
