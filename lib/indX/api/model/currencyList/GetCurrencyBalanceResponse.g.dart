...
part of 'GetCurrencyBalanceResponse.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GetCurrencyBalanceResponse _$GetCurrencyBalanceResponseFromJson(
        Map<String, dynamic> json) =>
    GetCurrencyBalanceResponse(
      data: json['data'] == null
          ? null
          : CurrencyBalanceData.fromJson(json['data'] as Map<String, dynamic>),
    )
...
Map<String, dynamic> _$GetCurrencyBalanceResponseToJson(
        GetCurrencyBalanceResponse instance) =>
    <String, dynamic>{
