...
BankData _$BankDataFromJson(Map<String, dynamic> json) => BankData(
      accountLimit: (json['accountLimit'] as num?)?.toInt(),
      sprintBankID: (json['sprintBankID'] as num?)?.toInt(),
      code: json['code'] as String?,
      bankType: json['bankType'] as String?,
      logo: json['logo'] as String?,
      id: (json['id'] as num?)?.toInt(),
      bankName: json['bankName'] as String?,
      iin: (json['iin'] as num?)?.toInt(),
      isIMPS: json['isIMPS'] as bool?,
      isNEFT: json['isNEFT'] as bool?,
      isACVerification: json['isACVerification'] as bool?,
      isaepsStatus: json['isaepsStatus'] as bool?,
      ifsc: json['ifsc'] as String?,
      aadhpayIIN: (json['aadhpayIIN'] as num?)?.toInt(),
      iscashDeposit: json['iscashDeposit'] as bool?,
      isAadharpay: json['isAadharpay'] as bool?,
    )
...
Map<String, dynamic> _$BankDataToJson(BankData instance) => <String, dynamic>{
      ...
      'sprintBankID': instance.sprintBankID,
      'code': instance.code,
      ...
      'iin': instance.iin,
      'isIMPS': instance.isIMPS,
      'isNEFT': instance.isNEFT,
      'isACVerification': instance.isACVerification,
      'isaepsStatus': instance.isaepsStatus,
      'ifsc': instance.ifsc,
      'aadhpayIIN': instance.aadhpayIIN,
      'iscashDeposit': instance.iscashDeposit,
      'isAadharpay': instance.isAadharpay,
    };
