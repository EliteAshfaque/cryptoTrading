...
part of 'Google2FAResponse.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Google2FAResponse _$Google2FAResponseFromJson(Map<String, dynamic> json) =>
    Google2FAResponse(
      referenceId: (json['referenceId'] as num?)?.toInt(),
      accountSecretKey: json['accountSecretKey'] as String?,
      qrCodeSetupImageUrl: json['qrCodeSetupImageUrl'] as String?,
      qrCodeSetupKey: json['qrCodeSetupKey'] as String?,
...
Map<String, dynamic> _$Google2FAResponseToJson(Google2FAResponse instance) =>
    <String, dynamic>{
      ...
      'qrCodeSetupImageUrl': instance.qrCodeSetupImageUrl,
      'qrCodeSetupKey': instance.qrCodeSetupKey,
