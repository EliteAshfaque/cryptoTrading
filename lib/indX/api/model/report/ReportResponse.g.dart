...
ReportResponse _$ReportResponseFromJson(Map<String, dynamic> json) =>
    ReportResponse(
      ledgerReport: (json['ledgerReport'] as List<dynamic>?)
          ?.map((e) => LedgerReport.fromJson(e as Map<String, dynamic>))
          .toList(),
      data: (json['data'] as List<dynamic>?)
          ?.map((e) => ReportData.fromJson(e as Map<String, dynamic>))
          .toList(),
      incomeWiseReport: (json['incomeWiseReport'] as List<dynamic>?)
          ?.map((e) => IncomeReport.fromJson(e as Map<String, dynamic>))
          .toList(),
    )
...
Map<String, dynamic> _$ReportResponseToJson(ReportResponse instance) =>
    <String, dynamic>{
      ...
      'ledgerReport': instance.ledgerReport,
      'data': instance.data,
      'incomeWiseReport': instance.incomeWiseReport,
    };
