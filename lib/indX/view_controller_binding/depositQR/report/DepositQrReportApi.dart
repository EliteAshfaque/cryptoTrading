...
class DepositQrReportApi{
  GetStorage storage = Get.find();
  PackageInfo packageInfo = Get.find();

  Future<void> getReport(int currencyId,String fromDate,String toDate, LoginData loginData, Function? callBack) async {

    await ApiClientConst.getApiClient()?.getAutoDepositHistory(AppSessionBasicRequest(request: jsonDecode('{"FromDate":"$fromDate","ToDate":"$toDate","CurrencyId":$currencyId}'),
