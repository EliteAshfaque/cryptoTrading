...
class BinaryBusinessReportController extends GetxController {
  ...
  Future<void> getBinaryBusiness(bool isFromClick) async {
    if(isFromClick){
    DialogBuilder.INSTANCE.showLoadingIndicator('', 'Getting Business ...', isCancelabel: false);}
    await api.getBinaryBusinessReport(isFromClick, filterOPID,filterLeg=="Left"?"L":filterLeg=="Right"?"R":"All",
