...
class BinaryBusinessReportPage extends StatelessWidget {
  BinaryBusinessReportController controller = Get.find();

  @override
  Widget build(BuildContext context) {
    return AppBarView(
        titleText: "${controller.filterLeg=="All"?"Total":controller.filterLeg} Business Report",
                        ...
                        onChanged: (value) {
                          if (value.isNotEmpty) {
                            controller.searchBusinessList.value = controller.businessList
                                ...
                                (element.position ?? "").toLowerCase().contains(value.toLowerCase()) ||
                                "${element.amount ?? 0}".toLowerCase().contains(value.toLowerCase()) |
                                "${element.parentId ?? 0}".toLowerCase().contains(value.toLowerCase()) ||
                       ...
                       children: [
                             ...
                             children: [
                               Flexible(
                                 ...
                                 Container(
                                     ...
                                     child: Text("Position : ${(item.position ?? "")=="L"?"Left":"Right"}",
                                         style: poppins(
                                             color: Colors.white,
                                             fontSize: 10,
                                             fontWeight: FontWeight.w600))),
                         ...
                         Padding(
                           ...
                           child: Row(
                             mainAxisAlignment: MainAxisAlignment.spaceBetween,
                             children: [
                               Text("Parent Id : ",style: poppins(color: lightPurple,fontWeight: FontWeight.w600,fontSize: 11)),
                               Flexible(child: Text("${item.parentId ?? 0}",style: poppins(color: red_2,fontWeight: FontWeight.w500,fontSize: 11)))
                             ],
                           ),
                         ),
                         const Divider(color: primaryColor,height: 0,endIndent: 10,indent: 10),
                         Padding(
                           ...
                           child: Row(
                             ...
                             children: [
                               ...
                               Flexible(child: Text(item.parentName??"",style: poppins(color: red_2,fontWeight: FontWeight.w500,fontSize: 11)))
                             ],
                           ),
                         ),
                         const Divider(color: primaryColor,height: 0,endIndent: 10,indent: 10),
                                 ...
                                 padding: const EdgeInsets.symmetric(vertical: 2,horizontal: 8),
                                   decoration: const BoxDecoration(
                                                  ...
                                                  borderRadius:
                                                      BorderRadius.all(
                                                          Radius.circular(8))),
                                   child: Text(Utility.INSTANCE.formatedAmountWithOutRupees(item.amount ?? 0.0),
                                       style: poppins(
                                           color: gray_1,
                                           fontWeight:
                                           FontWeight.w500,
                     ...
                     heightSpace_20,
                      ...
                      InkWell(
                          onTap: () async {
                            ...
                            Get.back();
                            controller.getBinaryBusiness(true);
