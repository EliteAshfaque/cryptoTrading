...
SWIFT_CLASS("_TtC14PhoneNumberKit31CountryCodePickerViewController")
...
@interface CountryCodePickerViewController (SWIFT_EXTENSION(PhoneNumberKit))
@end

@class UISearchController;

@interface CountryCodePickerViewController (SWIFT_EXTENSION(PhoneNumberKit)) <UISearchResultsUpdating>
...
- (void)textFieldDidChangeSelection:(UITextField * _Nonnull)textField SWIFT_AVAILABILITY(tvos,introduced=13.0) SWIFT_AVAILABILITY(ios,introduced=13.0);
@end



@interface PhoneNumberTextField (SWIFT_EXTENSION(PhoneNumberKit))
